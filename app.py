...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "assistant", "content": "¡Hola! 👋 Soy el asistente del PAE. ¿En qué duda operativa o normativa te puedo apoyar?"}
    ]
...
if prompt := st.chat_input("Escribe tu consulta aquí..."):
    ...
    with st.chat_message("assistant"):
        ...
        system_instruction = f"""Eres un asistente del Programa de Asesores Electorales (PAE) del TSE Costa Rica.
Responde de forma clara y precisa basándote ÚNICAMENTE en el siguiente contexto:
